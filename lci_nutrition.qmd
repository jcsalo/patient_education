...
Protein $\rightarrow$ muscle and wound healing
- Men: Average need 75 grams/day
- Women: Average need 60 grams/day
Carbohydrates $\rightarrow$ energy
- Starches are healthier than sugars
Fats $\rightarrow$ help food taste appetizing
- American diet usually has too much fat
...
Protein shakes will be an important part of recovery after surgery
:::
::::
...
## Jejunostomy Tube Video


::::::: columns
:::: {.column width="50%"}
::: {.content-visible unless-format="docx"}
This video provides more information about feeding jejunostomy
:::
::::

:::: {.column width="50%"}
::: {.content-visible unless-format="docx"}
{{< qrcode https://jmbuhr.de width = 400 height = 400 >}}
:::
::::
:::::::
