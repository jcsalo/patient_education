...
The type of surgery required will depend upon type of stomach tumor.
...
As a result, surgery for a GI Stromal Tumor does not require removal of as much stomach and does not require removal of nearby lymph nodes
...
…and the stomach wall sewn back together.  
...
This operation is suitable for small tumors in the lower part of the stomach.


This operation can also be used to treat ulcer disease, benign tumors in the lower stomach, and reduce gastrin production in patients with neuroendocrine tumors.

## Slide 18

A distal gastrectomy is suitable for tumors in this location

## Slide 19

The bottom half of the stomach is removed…

## Slide 20

… and connected to the small intestines.
...
Treatment of tumors in the upper stomach, called “proximal tumors” represent a challenge.
...
Laparoscopic techniques use instruments which can be as small as the diameter of a pencil

## Robotic Techniques

A variation of laparoscopic techniques are robotic techniques. 

In this case, the surgeon works from a 3-d monitor

## Robotic Techniques

The surgeon direct the robot using hand controls

## Robotic Techniques

Which are connected to the robotic arms
