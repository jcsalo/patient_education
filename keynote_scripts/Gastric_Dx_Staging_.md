...
From the esophagus it passes into the stomach.

## Text

Food then passes from the stomach into the small bowel, called the jejunum.
...
In most cases, the diagnosis of gastric cancer is made by endoscopy, also called an EGD for esophago-gastroduodenoscopy (15)
...
The biopsy is examined by a pathologist, who will determine whether the tumor is benign or whether it is cancer
...
The first is the tumor. How large is the tumor? And more importantly, how deeply has it grown into the wall of the stomach?
...
It can be difficult to tell how deep a tumor has invaded just by looking from the surface at the time of endoscopy or EGD
...
A PET scan is the best test to know whether a cancer has spread to lymph nodes.
...
The CT scan and PET scans are used to look for signs of spread to these organs.

## Abdominal Cavity

An additional site of potential spread is inside the abdominal cavity.
