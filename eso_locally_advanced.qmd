...
format: 
  revealjs:
    ...
    theme: default
    echo: false
    output-file: eso_locally_advanced_slides.html
  pdf:
...
!!! Need graphic/animation with micrometastatic disease !!!

::::: columns
::: {.column .fragment width="50%"}
Patients with locally-advanced esophageal cancer have a visible mass, or tumor, which frequently causes trouble swallowing.

What we don't always recognize is that in many cases there can be microscopic areas of tumor which can't be seen with the naked eye.

If surgery is the only treatment given, those microscopic areas of tumor can later cause a recurrence of cancer.
:::

::: {.column .fragment width="50%"}
![](images/Eso_Resection2Artboard%202@4x.png)
:::
:::::
...
Research has shown that preoperative therapy to shrink the the tumor is the more effective than surgery alone for T3 or node-positive tumors.

There are two different methods of shrinking a tumor prior to surgery, and the preferred method depends upon the type of tumor
