...
format: 
  revealjs:
    ...
    theme: default
    echo: false
    output-file: eso_aca_locally_advanced_slides.html
  pdf:
...
For patients with locally-advanced esophageal cancer, research has shown that preoperative treatment to shrink the cancer makes the surgery more effective by killing microscopic tumor cells that can't be detected at the time of surgery.

There are two different treatments which have been shown to be effective

- Radiation and chemotherapy for 5 1/2 weeks followed by surgery

- Chemotherapy every other week for 8 weeks both before and after surgery
...
A second approach is to use chemotherapy alone.

A combination of drugs is administered intravenously every other week for 4 doses *before* surgery. After surgery, another 4 doses of chemotherapy are adinistered. 
