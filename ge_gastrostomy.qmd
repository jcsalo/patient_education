...
Whatever the method used to place a feeding tube, it can be used to administer the following:

1) Feedings using a liquid formula similar to Boost or Ensure
2) Water
3) Medicines
